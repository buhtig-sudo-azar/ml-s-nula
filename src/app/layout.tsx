...
export const metadata: Metadata = {
  ...
  description:
    "Бесплатное интерактивное приложение для новичков: разберитесь, что такое признаки, веса и метки, как модель учится на ошибках и почему данные решают всё. 10 модулей с живыми песочницами.",
  keywords: [
    "машинное обучение",
    "ML для новичков",
    "веса модели",

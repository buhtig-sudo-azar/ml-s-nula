...
const RESOURCES: Resource[] = [
  {
    ...
    type: "article",
    description:
      "Подробный гайд по самостоятельному изучению ML бесплатно: от Python и математики до классического ML и соревнований на Kaggle. Дорожная карта для новичка без бюджета.",
    topic_focus: "general",
  },
  {
  ...
  },
  {
    ...
    type: "course",
    description:
      "Бесплатный курс от Сколково с видеолекциями и практикой, знакомящий с основами Data Science и ML. Подходит тем, кто только начинает путь.",
    topic_focus: "general",
  },
  {
    ...
    type: "course",
    description:
      "Бесплатный вводный курс про большие данные: обработка пропусков, аномалий и знакомство с моделями. Мягкий старт без сильной математики.",
    topic_focus: "general",
  },
  {
    ...
    type: "course",
    description:
      "Четырёхнедельный бесплатный курс по основам ИИ и МО. Структурированный путь для тех, кто хочет быстро получить общую картину.",
    topic_focus: "general",
  },
  {
  ...
  {
    title: "Бесплатные курсы по машинному обучению на русском — Neurohive",
    url: "https://neurohive.io/ru/novosti/besplatnye-kursy-mashinnoe-obuchenie",
    language: "ru",
    type: "article",
    description:
      "Подборка из 17 бесплатных русскоязычных курсов по ML, Data Science и Python, включая курс Эндрю Ына. Удобный каталог для выбора старта.",
    topic_focus: "general",
  },
  {
    ...
    type: "course",
    description:
      "Бесплатный 15-часовой курс Google с анимированными видео, интерактивными визуализациями и практикой. Классика для старта: от признаков и меток до градиентного спуска и функций потерь.",
    topic_focus: "general",
  },
  {
  ...
  },
  {
    ...
    type: "interactive",
    description:
      "Каталог из 12 бесплатных микро-курсов по 1–7 часов каждый: Python, Pandas, ML, feature engineering. Удобно собирать знания короткими сессиями с автопроверкой.",
    topic_focus: "general",
  },
  {
  ...
  },
  {
    ...
    type: "course",
    description:
      "12-недельная, 26-урочная учебная программа по классическому ML с заданиями и проектами от Microsoft. Полностью бесплатная и нацелена именно на начинающих.",
    topic_focus: "general",
  },
  {
  ...
  },
  {
    ...
    type: "book",
    description:
      "Бесплатный интерактивный учебник с кодом на PyTorch/NumPy/TensorFlow, принятый в 500+ университетах. Совмещает концепции, математику и runnable-ноутбуки.",
    topic_focus: "algorithms",
  },
  {
    ...
    type: "book",
    description:
      "Бесплатный онлайн-учебник, специально написанный для новичков: как нейросети распознают цифры, что такое веса, смещения и обучение через градиентный спуск. Очень доступный стиль.",
    topic_focus: "terms",
  },
  {
    ...
    type: "course",
    description:
      "Обновлённая специализация Эндрю Ына от Stanford/DeepLearning.AI с возможностью бесплатного аудита. Золотой стандарт вводного курса: линейная регрессия, градиентный спуск, функции потерь.",
    topic_focus: "general",
  },
  {
  ...
  },
  {
    ...
    type: "course",
    description:
      "Подборка бесплатных курсов MIT по математике и основам ML для глубокого понимания. Авторитетный источник для тех, кто хочет фундаментальный английский путь.",
    topic_focus: "general",
  },
];
